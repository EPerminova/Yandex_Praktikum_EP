...
# 6. Классификаиция клиентов телеком компании [(Project_6)]()
*Спринт:*
Введение в МО
...
# 7. Прогнозирование оттока клиента Банка [(Project_7)]()
*Спринт:*
Обучение с учителем
...
# 8. Определение наиболее выгодного региона нефтедобычи [(Project_8)]()
*Спринт:*
...
# 9. Исследование технологического процесса очистки золота [(Project_9)]()
*Спринт:*
...
# 10. Защита данных клиентов страховой компании [(Project_10)]()
*Спринт:*
Линейная алгебра
...
# 11. Построение модели определения стоимости автомобиля [(Project_11)]()
*Спринт:*
Численные методы
...
# 12. Прогнозирование количества заказов такси на следующий час [(Project_12)]()
*Спринт:*
Временные ряды
...
# 13. Обучение модели классификации комментариев [(Project_13)]()
*Спринт:*
МО для текстов
...
# 14. Выпускной проект [(Project_14)]()
*Спринт:*
...
# 15. Выявление определяющей успешность игры закономерности. [(Project_15)]()
*Спринт:*
Сборный Проект — 1
